...
> Copied from the private `github.com/kakkoyun/gopherconuk-26` talk repository at commit `e456e774cc3bb842af171c0041c874783e1071cc`. The source repository remains authoritative. The sole author relicensed this copy from Apache-2.0 to MIT.
...
**The result**: a 10% regression can vanish into shared-runner noise. A 10% speedup can appear where none exists. Directional errors — CI reporting a regression that is actually a speedup — happen in practice ([DataDog/dd-trace-go#4891](https://github.com/DataDog/dd-trace-go/pull/4891) produced this directional error).
...
7. DataDog/dd-trace-go#4891 (directional error in practice): <https://github.com/DataDog/dd-trace-go/pull/4891>
